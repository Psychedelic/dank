...
const BUCKET_WASM: &[u8] =
    include_bytes!("../../../target/wasm32-unknown-unknown/debug/sdr_history_bucket-deb-opt.wasm");

#[cfg(not(debug_cfg))]
const BUCKET_WASM: &[u8] = include_bytes!(
    "../../../target/wasm32-unknown-unknown/release/sdr_history_bucket-rel-opt.wasm"
);
