...
const BUCKET_WASM: &[u8] =
    include_bytes!("../../../target/wasm32-unknown-unknown/debug/xdr_history_bucket-deb-opt.wasm");

#[cfg(not(debug_cfg))]
const BUCKET_WASM: &[u8] = include_bytes!(
    "../../../target/wasm32-unknown-unknown/release/xdr_history_bucket-rel-opt.wasm"
);
